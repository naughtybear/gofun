...
func filenameFromCommondLine() (inFilename, outFilename string, err error) {
...
func main() {
	inFilename, outFilename, err := filenameFromCommondLine()
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
...
func americanise(inFile io.Reader, outFile io.Writer) (err error) {
	...
	var replacer func(string) string // 函数是第一类值
